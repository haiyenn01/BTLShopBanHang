        ...
        <tbody>
          ...
          <tr>
            ...
            <td><span class="text-ellipsis">
              ...
              ?>  
            <a href="{{URL::to('/unactive-brand-product/'.$brand_pro->brand_id)}}"><span class=" fa fa-toggle-on"></span></a>
              <?php
                }else{
              ?>  
            <a href="{{URL::to('/active-brand-product/'.$brand_pro->brand_id)}}"><span class=" fa fa-toggle-off"></span></a>
              <?php    
                }
              ?>
