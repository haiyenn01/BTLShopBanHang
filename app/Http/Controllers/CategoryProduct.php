...
class CategoryProduct extends Controller
{
   ...
   public function unactive_category_product($category_product_id){
    ...
    public function show_category_home($category_id){
        ...
        return view('pages.category.show_category')->with('category', $cate_product)->with('category_by_id',$category_by_id)->with('brand',$brand_product)->with('category_name',$category_name);
    }
